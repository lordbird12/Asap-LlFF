...
@Component({
    selector: 'layout-postpon',
    templateUrl: './layout-postpon.component.html',
    styleUrls: ['./layout-postpon.component.scss'],
...
export class LayoutPostponComponent implements OnInit, OnDestroy {
    config: FuseConfig;
    layout: string;
    scheme: 'dark' | 'light';
    theme: string;
