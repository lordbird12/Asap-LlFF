...
import { BookingLayoutComponent } from './layouts/vertical/booking/booking.component';

@Component({
    selector: 'layout-calendar',
    templateUrl: './layout-calendar.component.html',
    styleUrls: ['./layout-calendar.component.scss'],
...
export class LayoutCalendarComponent implements OnInit, OnDestroy {
    config: FuseConfig;
    layout: string;
    scheme: 'dark' | 'light';
    theme: string;
